...
@Controller
@RequestMapping(value="/budgetcycles.htm")
public class BudgetCyclesController {
	...
	public String loadForm(ModelMap model, HttpSession session) {
		...
		if (currentUser != null) {
			...
			budgetCycleForm.setBudgetCycleList(budgetCycleService.loadBudgetCyclesByUser(currentUser));
	...
	public String processSubmit(@ModelAttribute("budgetCycleForm") BudgetCycleForm budgetCycleForm, 
		...
		//returns the view name
		return "redirect:budgetcycles.htm";
	}
